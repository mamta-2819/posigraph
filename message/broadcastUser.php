...
//         $total=getUnreadMsg($_SESSION['id'],$userId);
//        if($total!=0)
//            $read="($total)";
//        else
//            $read="";
            ...
            echo "
              ...
              <p style='color:cyan;font-size:18px'> <b>$userName</b>
              <input type='checkbox' value='{$userId}' name='brdcstRL[]'>
              <span><i style='color: $color;font-size: 20px;' class='fa fa-circle' aria-hidden='true'></i>$flag</span></p> </div> <hr>";
