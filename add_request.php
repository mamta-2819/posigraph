    ...
    if (isset($_POST['submit'])) 
    {
        if (count($_FILES) > 0) {
                if (is_uploaded_file($_FILES['pic']['tmp_name'])) {
                    ...
                    $sql = "INSERT INTO `battle`(`player1_id`, `player1_post`,`player2_id`, `status`) VALUES ('$me','$imgData','$pid','1')";
                    // echo $sql = "UPDATE `battle` SET `player1_post`='test',`player1_id`='$pid' WHERE `player1_id`='$pid'"; exit;
                    if(mysqli_query($conn,$sql))
                    {
                        echo "  <script>
                                    alert('Your Picture is uploaded & battle request is sent!!');
                                    window.location='./battle-new/battle.php';
                                </script>";
                    }
                }
            }
...
<div class="container-fluid" style="margin-top: 100px;">
    ...
    <div id='pop-up-div' class="col-sm-10 col-xs-11 "><br>
        ...
        <div class="col-md-12">          
            <h6 class="h4"> Welcome <?php echo $_SESSION['name']?> Upload Image to challenge your friend</h6>
            <div class="">
